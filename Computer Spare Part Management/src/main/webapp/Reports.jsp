...
<div class="sidebar">
    ...
    <a href="Reports.jsp" class="nav-link active">Reports</a>
       ...
       <a href="Login.jsp" class="logout-btn" style="text-align: center; display: block; text-decoration: none;">Logout</a>
    </div>
...
%>
    ...
    <script>
        const productNames = <%= gson.toJson(productNames) %>;
