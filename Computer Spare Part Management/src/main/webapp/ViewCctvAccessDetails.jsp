...
<head>
    <meta charset="UTF-8">
    <title>CCTV Accessory Details</title>
    <style>
        body {
...
%>
    <div class="details-container">
        <img src="<%= rs.getString("image_url") %>" alt="CCTV Accessory Image" />
        ...
        <a href="cctvcamera.jsp" class="back-link">Back to CCTV Accessories</a>
    </div>
<%
        } else {
