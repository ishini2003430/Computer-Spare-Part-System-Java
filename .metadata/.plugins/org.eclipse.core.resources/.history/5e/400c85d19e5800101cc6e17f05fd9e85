...
<html>
<head>
    <title>View Printers - TechParts</title>
    <style>
        body {
...
<div class="top-buttons">
    <a href="Categories.jsp" class="btn-back">← Back to Categories</a>
    <a href="AddPrinter.jsp" class="add-button">Add New Printer</a>
</div>
    ...
    %>
        <tr>
            ...
            <td>
                ...
                %>
                    <img src="<%= imgUrl %>" alt="Printer Image" />
                <%
                    } else {
                %>
                    No Image
            ...
            <td>
                <a href="editprinter.jsp?id=<%= rs.getInt("id") %>" class="btn btn-edit">Edit</a> |
                <a href="DeletePrinterServlet?id=<%= rs.getInt("id") %>" class="btn btn-delete" onclick="return confirm('Are you sure you want to delete this printer?');">Delete</a>
            </td>
        </tr>
    <%
            }
