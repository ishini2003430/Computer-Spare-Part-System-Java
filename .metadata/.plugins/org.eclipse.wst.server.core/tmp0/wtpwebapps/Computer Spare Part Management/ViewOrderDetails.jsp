...
<html>
<head>
    <title>View Order Details - TechParts</title>
    <meta charset="UTF-8" />
    <style>
        /* --- Paste your sidebar & general CSS here from ManagerDashboard.jsp --- */
...
<div class="sidebar">
    <div>
        ...
        <a href="ViewOrderDetails.jsp" class="nav-link active">Orders</a>
...
<!-- Main Content -->
<div class="main">
    <h1>All Orders and Their Items</h1>
